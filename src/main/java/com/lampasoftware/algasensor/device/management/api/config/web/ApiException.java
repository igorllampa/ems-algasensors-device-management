package com.lampasoftware.algasensor.device.management.api.config.web;

import com.lampasoftware.algasensor.device.management.api.client.SensorMonitoringClientBadGatewayException;
